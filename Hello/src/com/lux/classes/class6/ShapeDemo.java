...
public class ShapeDemo {
    ...
    public static void main(String[] args) {
        ...
        //Ѕудет вызван конструктор по умолчанию дл€ супер-класса и инициализирован атрибут color дл€ данного обэъкта
	...
	//переменной супер-класса можно присвоить ссылку на любой ее нижесто€щий класс в иерархии, но не обратно!
        ...
        System.out.println("÷вет линии1 shape111233777 is " + shape2.getColor());

        //объект типа Line1 нарисует себа
        shape2.draw();
        rec1.draw();
        System.out.println("ѕлощадь Rectangle1 rec1 is " + rec1.getArea());

        //Arrays.sort(shapes); //сортировка наших форм, дл€ которых имплементирован интерфейс Comparable
        ...
        // иначе получим ClassCastExc) и приведени€ объектов к интерфейсу Comparable мы можем сортировать любые объекты: Rectangle1, Line1, ...
	}
