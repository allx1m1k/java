 ...
 */
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		 ...
		 //обращение к статическим полям - моветон, т.к. обращаесмя через имя объекта а не класса
		 ...
		 rect1.setWidth(100); //присвоить ссылке на первый объект ссылку на второй объект, теперь разные ссылки смотрят на один и тот же объект
	 ...
	 *  rect1 = rect2; тут rect1 стал ссылать на объект rect2 и rect1 уже потерян в программе
	 *  сборщик мусора удалит первый объект в программе
	 *  
	 */
